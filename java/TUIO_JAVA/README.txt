...
Demo Applications:
------------------
This package contains two demo applications which receive
TUIO messages from the reacTIVision engine. Both applications
show how to use the TUIO Java Library in a simple way.
