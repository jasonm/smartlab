...
public final class AL11 {
	...
	private static native void nalListener3i(int pname, int v1, int v2, int v3);
	...
	public static void alGetListeneri(int pname, FloatBuffer intdata) {
		FloatBuffer intdata_saved = intdata;
		intdata = NondirectBufferWrapper.wrapNoCopyBuffer(intdata, 1);
		nalGetListeneriv(pname, intdata, intdata.position());
		Util.checkALError();
		NondirectBufferWrapper.copy(intdata, intdata_saved);
	}
	private static native void nalGetListeneriv(int pname, FloatBuffer intdata, int intdata_position);
	...
	private static native void nalSource3i(int source, int pname, int v1, int v2, int v3);
	...
	private static native void nalSourceiv(int source, int pname, IntBuffer value, int value_position);
	...
	private static native void nalBufferf(int buffer, int pname, float value);
	...
	private static native void nalBuffer3f(int buffer, int pname, float v1, float v2, float v3);
	...
	private static native void nalBufferfv(int buffer, int pname, FloatBuffer value, int value_position);
	...
	private static native void nalBufferi(int buffer, int pname, int value);
	...
	private static native void nalBuffer3i(int buffer, int pname, int v1, int v2, int v3);
	...
	private static native void nalBufferiv(int buffer, int pname, IntBuffer value, int value_position);
	...
	public static void alGetBuffer(int buffer, int pname, IntBuffer values) {
		...
		values = NondirectBufferWrapper.wrapNoCopyBuffer(values, 1);
		nalGetBufferiv(buffer, pname, values, values.position());
		Util.checkALError();
		NondirectBufferWrapper.copy(values, values_saved);
	}
	private static native void nalGetBufferiv(int buffer, int pname, IntBuffer values, int values_position);
	...
	private static native void nalGetBufferfv(int buffer, int pname, FloatBuffer values, int values_position);
	...
	private static native void nalSpeedOfSound(float value);
}
